...
class ErrorCode:
    ...
    CODE_REQUEST_TIMEOUT = 7
    CODE_HTTP_ERROR = 8
    CODE_INVALID_URL = 9
    CODE_HTTP_STATUS = 10
    CODE_DATABASE_ERROR = 11
    CODE_INVALID_PATIENTS_SERVICE_RESPONSE = 12
    CODE_INVALID_PHYSICIANS_SERVICE_RESPONSE = 13
    CODE_INVALID_METRICS_SERVICE_RESPONSE = 14

    # optional errors, client service data is not mandatory to create a prescription
    CODE_CLINIC_NOT_FOUND = 15
    CODE_CLINICS_SERVICE_NOT_AVAILABLE = 16
    CODE_INVALID_CLINICS_SERVICE_RESPONSE = 17
